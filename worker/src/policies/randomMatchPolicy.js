export function isEligibleRandomPair(seeker,candidate,active={}){
  ...
  if(seeker.blockedRefs?.some(ref=>ref===candidate.identityId||ref===candidate.accountUserId)||candidate.blockedRefs?.some(ref=>ref===seeker.identityId||ref===seeker.accountUserId))return false;
