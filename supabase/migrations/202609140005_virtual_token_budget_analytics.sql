-- T-101 precondition (bot chat stays disabled -- this just gets the safety rail ready): a daily
-- token-usage counter for the virtual/bot chat feature, reusing the existing analytics_daily
-- aggregation rather than a new table. Adds 'virtual_tokens_used' to record_analytics_event's
-- fixed event-name allowlist.
