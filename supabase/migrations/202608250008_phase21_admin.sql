...
revoke all on function public.admin_dashboard_snapshot(),function public.admin_list_users(integer,integer),function public.admin_adjust_wallet(uuid,uuid,bigint,text,text),function public.admin_set_restriction(uuid,text,text,text),function public.update_virtual_config(uuid,bigint,jsonb),function public.admin_save_promotion(uuid,text,jsonb) from public,anon,authenticated;
grant execute on function public.admin_dashboard_snapshot(),function public.admin_list_users(integer,integer),function public.admin_adjust_wallet(uuid,uuid,bigint,text,text),function public.admin_set_restriction(uuid,text,text,text),function public.update_virtual_config(uuid,bigint,jsonb),function public.admin_save_promotion(uuid,text,jsonb) to service_role;
