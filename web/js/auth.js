...
import { oauthRedirectUrl } from "./oauth.js";
...
export async function signInWithGoogle(){if(!supabase)throw new Error("Google sign-in is unavailable until Supabase Auth is configured.");const {data,error}=await supabase.auth.signInWithOAuth({provider:"google",options:{redirectTo:oauthRedirectUrl()}});if(error)throw error;return data;}
